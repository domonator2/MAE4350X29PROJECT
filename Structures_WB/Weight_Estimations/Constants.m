...
C.n_ult = 6.5; %[G] ultimate load factor
C.W_GW = 13906; %[lbs] Gross Weight
...
[~, V, C.qD, ~] = flight_condition_calculator(40000, 'M', 0.9, 'EN'); % Vertical Dive Speed
C.VD = V/1.6878;
C.lambda_v = 0.306;
