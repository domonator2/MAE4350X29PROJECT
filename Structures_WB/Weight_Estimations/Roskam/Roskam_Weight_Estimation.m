...
[W_wing, W_v, W_c, W_emp, W_fus, W_n, W_g, W_str, W_cp] = Weight_Calculator(C);
...
Csys_guess = 2775; %[lbs] Initial system weight guess
...
Csys_range = linspace(2000,3000,100); %[lbs] range of constant system weight
...
Plot_Swet_vs_Istr(S_wet_metric, Istr_metric);
